...
with open('models/x_t9_AD2D.json', 'r') as file:
...
import joblib
model = joblib.load('models/table_9_AD2D.joblib')
encoder = joblib.load('models/y_9_AD2D.joblib')
import pandas as pd
...
def AD2D():
    DrugButton()
    solara.Text("AD2D (Bernoulli Naive Bayes)", style='margin-top:1rem;font-size:1.2rem;')
