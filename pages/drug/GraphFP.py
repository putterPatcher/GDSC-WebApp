...
with open('models/x_t9_GraphFP.json', 'r') as file:
...
import joblib
model = joblib.load('models/table_9_GraphFP.joblib')
encoder = joblib.load('models/y_9_GraphFP.joblib')
import pandas as pd
...
zero_value = solara.reactive(256)

@solara.component
def GraphFP():
    DrugButton()
    solara.Text("GraphFP (Bernoulli Naive Bayes)", style='margin-top:1rem;font-size:1.2rem;')
