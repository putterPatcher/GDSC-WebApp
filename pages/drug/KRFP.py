...
with open('models/x_t9_KRFP.json', 'r') as file:
...
import joblib
model = joblib.load('models/table_9_KRFP.joblib')
encoder = joblib.load('models/y_9_KRFP.joblib')
import pandas as pd
...
def KRFP():
    DrugButton()
    solara.Text("KRFP (Bernoulli Naive Bayes)", style='margin-top:1rem;font-size:1.2rem;')
